...
public class mod_Dqm extends BaseMod //implements IMinecraftRegistry
{
	...
	public void load()
	{
        ...
        ModLoader.addName(new ItemStack(DqmBlock, 1, 0), "ja_JP", "鉄鉱石の鉱石");
        ModLoader.addName(new ItemStack(DqmBlock, 1, 1), "ja_JP", "溶岩石の鉱石");
        ModLoader.addName(new ItemStack(DqmBlock, 1, 2), "ja_JP", "鏡の石の鉱石");
        ModLoader.addName(new ItemStack(DqmBlock, 1, 3), "ja_JP", "ミスリルの鉱石");
        ModLoader.addName(new ItemStack(DqmBlock, 1, 4), "ja_JP", "プラチナの鉱石");
        ModLoader.addName(new ItemStack(DqmBlock, 1, 5), "ja_JP", "メタルの鉱石");
