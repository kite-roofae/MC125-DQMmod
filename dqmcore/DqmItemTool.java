...
public class DqmItemTool extends ItemTool implements ITextureProvider
{
    ...
    protected DqmEnumToolMaterial toolMaterial;

    protected DqmItemTool(int par1, int par2, DqmEnumToolMaterial par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
    	super(par1,par2, EnumToolMaterial.EMERALD, par4ArrayOfBlock);
