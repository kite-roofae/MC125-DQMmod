...
public class DqmWorldGen extends WorldGenerator
{
    private int minableBlockId;
    private int numberOfBlocks;
    private int metadataID;

    public DqmWorldGen(int var1, int var2, int var3)
    {
        this.minableBlockId = var1;
        this.numberOfBlocks = var2;
        this.metadataID = var3;
    }
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                {
                                    var1.setBlockAndMetadata(var38, var41, var44, this.minableBlockId, this.metadataID);
                                }
                            }
                        }
                    }
