...
public class DqmDokukesisouSeed2 extends BlockFlower implements ITextureProvider
{
    public DqmDokukesisouSeed2(int i, int j)
    {
        super(i, j);
    ...
    public int idDropped(int i, Random random, int j)
    {
        ...
        if (i == 8)
        {
            return mod_Dqm.Dokukesisou2.shiftedIndex;
