...
public class DqmDokukesisouSeed extends BlockFlower implements ITextureProvider
{
    public DqmDokukesisouSeed(int i, int j)
    {
        super(i, j);
    ...
    public int idDropped(int i, Random random, int j)
    {
        ...
        if (i == 8)
        {
            return mod_Dqm.Dokukesisou.shiftedIndex;
