...
public class DqmSubayasaSeed extends BlockFlower implements ITextureProvider
{
    public DqmSubayasaSeed(int i, int j)
    {
        super(i, j);
    ...
    public int idDropped(int i, Random random, int j)
    {
        ...
        if (i == 8)
        {
            return mod_Dqm.Subayasanotane.shiftedIndex;
