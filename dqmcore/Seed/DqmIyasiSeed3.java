...
public class DqmIyasiSeed3 extends BlockFlower implements ITextureProvider
{
    public DqmIyasiSeed3(int i, int j)
    {
        super(i, j);
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
        ...
        if (world.getBlockLightValue(i, j + 1, k) >= 12)
        {
    ...
    public int idDropped(int i, Random random, int j)
    {
        ...
        if (i == 8)
        {
            return mod_Dqm.Iyasinomi3.shiftedIndex;
        }
        else
        {
            return -1;
