...
public class DqmDokukesisouSeed3 extends BlockFlower implements ITextureProvider
{
    public DqmDokukesisouSeed3(int i, int j)
    {
        super(i, j);
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
        ...
        if (world.getBlockLightValue(i, j + 1, k)<= 6)
        {
    ...
    public int idDropped(int i, Random random, int j)
    {
        ...
        if (i == 8)
        {
            return mod_Dqm.Dokukesisou3.shiftedIndex;
