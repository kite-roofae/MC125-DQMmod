...
public class DqmSubayasaSeed3 extends BlockFlower implements ITextureProvider
{
    public DqmSubayasaSeed3(int i, int j)
    {
        super(i, j);
    ...
    public int idDropped(int i, Random random, int j)
    {
        ...
        if (i == 8)
        {
            return mod_Dqm.Subayasanotane3.shiftedIndex;
