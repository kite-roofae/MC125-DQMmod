...
public class DqmpetEntitySuraimunaito extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntitySuraimunaito(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Suraimunaito.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.8F);
		//*******************************Speed***************************************
		moveSpeed = 0.45F;
	...
	{
		return this.isSitting() ? "/dqm/SuraimunaitoPetzzz.png" : isTamed() ? "/dqm/SuraimunaitoPet.png":(this.isAngry() ? "/dqm/Suraimunaito.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 29 : 29;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Haganenoturugi.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntitySuraimunaito var2 = new DqmpetEntitySuraimunaito(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntitySuraimunaito))
		{
			return false;
		}
		else
		{
			DqmpetEntitySuraimunaito var2 = (DqmpetEntitySuraimunaito)par1EntityAnimal;
