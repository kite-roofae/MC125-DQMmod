...
public class DqmEntitySuraimunaito extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntitySuraimunaito(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 29;    }
	//*******************************Armor***************************************
	...
	{            this.entityToAttack = null;        }
		...
		if (this.onGround)                {
			...
			this.motionX = var4 / var8 * 0.5D * 0.800000011920929D + this.motionX * 0.60000000298023224D;
