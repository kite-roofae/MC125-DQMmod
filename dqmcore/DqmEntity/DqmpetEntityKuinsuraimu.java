...
public class DqmpetEntityKuinsuraimu extends DqmEntityTameable
{
	//*******************************ATK***************************************
	protected int attackStrength = 11;
	/**
	...
	public DqmpetEntityKuinsuraimu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Kuinsuraimu.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.5F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.45F;
	...
	{
		return this.isSitting() ? "/dqm/KuinsuraimuPetzzz.png" : isTamed() ? "/dqm/KuinsuraimuPet.png":(this.isAngry() ? "/dqm/Kuinsuraimu.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 60 : 60;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Puratina.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityKuinsuraimu var2 = new DqmpetEntityKuinsuraimu(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityKuinsuraimu))
		{
			return false;
		}
		else
		{
			DqmpetEntityKuinsuraimu var2 = (DqmpetEntityKuinsuraimu)par1EntityAnimal;
