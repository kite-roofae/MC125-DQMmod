...
public class DqmpetEntityIkkakuusagi extends DqmEntityTameable
{
	...
	public DqmpetEntityIkkakuusagi(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Ikkakuusagi.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 0.8F);
		//*******************************Speed***************************************
		moveSpeed = 0.35F;
	...
	{
		return this.isSitting() ? "/dqm/IkkakuusagiPetzzz.png" : isTamed() ? "/dqm/IkkakuusagiPet.png": super.getTexture();
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 15 : 15;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Uruwasikinoko.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityIkkakuusagi var2 = new DqmpetEntityIkkakuusagi(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityIkkakuusagi))
		{
			return false;
		}
		else
		{
			DqmpetEntityIkkakuusagi var2 = (DqmpetEntityIkkakuusagi)par1EntityAnimal;
