...
public class DqmEntityMeragosuto extends DqmEntityMob
{
	...
	public DqmEntityMeragosuto(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Meragosuto.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.7F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.3F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 18;    }
	//*******************************Armor***************************************
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		//Randam 0-1
		this.dropItem(mod_Dqm.Umanofun.shiftedIndex, 1);
	...
	if (this.isBurning())    {//Fire
		//this.dropItem(mod_Dqm.Meragosutonotubasa.shiftedIndex, 1);
	...
	//case 2:dropItem(mod_Dqm.Meragosutonotubasa.shiftedIndex, 1);                break;
	//case 2:dropItem(mod_Dqm.Sabitayoroi.shiftedIndex, 1);                break;
	//case 2:dropItem(mod_Dqm.Sabitakote.shiftedIndex, 1);                break;
	case 3:dropItem(mod_Dqm.Sabitakote.shiftedIndex, 1);                break;
	}}
