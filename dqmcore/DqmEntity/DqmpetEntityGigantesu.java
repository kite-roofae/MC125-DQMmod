...
public class DqmpetEntityGigantesu extends DqmEntityTameable
{
	//*******************************ATK***************************************
	protected int attackStrength = 20;
	/**
	...
	public DqmpetEntityGigantesu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	{
		return this.isSitting() ? "/dqm/GigantesuPetzzz.png" : isTamed() ? "/dqm/GigantesuPet.png": super.getTexture();
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 95 : 95;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Seireiseki.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityGigantesu var2 = new DqmpetEntityGigantesu(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityGigantesu))
		{
			return false;
		}
		else
		{
			DqmpetEntityGigantesu var2 = (DqmpetEntityGigantesu)par1EntityAnimal;
