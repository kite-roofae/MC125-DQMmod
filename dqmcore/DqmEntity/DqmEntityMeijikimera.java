...
public class DqmEntityMeijikimera extends DqmEntityMob
{
	...
	public DqmEntityMeijikimera(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Meijikimera.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 2.0F);
		//*******************************Speed***************************************
		moveSpeed = 0.5F;
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		...
		//this.dropItem(mod_Dqm.Yougansekinokakera.shiftedIndex, 1);
		this.dropItem(mod_Dqm.Meijikimeranohane.shiftedIndex, 1);
	}
