...
public class DqmEntityPuratinaking extends DqmEntityMob
{

	private int field_40152_d;
	public DqmEntityPuratinaking(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Puratinaking.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.0F);
		//*******************************Speed***************************************
		//moveSpeed = 0.25F;
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		...
		this.dropItem(mod_Dqm.Kingdaiya.shiftedIndex, 1);
	...
	case 3:dropItem(mod_Dqm.Metarukingnoyoroi.shiftedIndex, 1);                break;
