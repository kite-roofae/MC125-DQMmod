...
public class DqmEntityTahodoraki extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityTahodoraki(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Tahodoraki.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 1.4F);
		//*******************************Speed***************************************
		moveSpeed = 0.5F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 34;    }
	//*******************************Armor***************************************
