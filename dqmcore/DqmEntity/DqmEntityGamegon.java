...
public class DqmEntityGamegon extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityGamegon(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Gamegon.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(2.0F, 1.3F);
		//*******************************Speed***************************************
		moveSpeed = 0.20F;
	...
	/*
    		...
    		[Misriru][MysteryEgg][Oriharukon][Puratina][Rotonoha][Rotonotuka][Seijanohai][Seireiseki][Sinkanohiseki][Subayasanotane][Gamegonimunokanmuri]
    		[Gamegonimuzeri][Syurizai][Tekkouseki][Tikaranotane][Tokinosuisyou][Tyounohane][Uruwasikinoko][Usaginosippo][Yakusou][Yawarakauru]
	...
	//case 3:dropItem(mod_Dqm.Gamegonimuhead.shiftedIndex, 1);                break;
