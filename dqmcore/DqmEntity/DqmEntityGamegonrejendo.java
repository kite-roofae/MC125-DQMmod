...
public class DqmEntityGamegonrejendo extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityGamegonrejendo(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Gamegonrejendo.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(2.0F, 1.3F);
		//*******************************Speed***************************************
		moveSpeed = 0.30F;
	...
	/*
    		...
    		[Misriru][MysteryEgg][Oriharukon][Puratina][Rotonoha][Rotonotuka][Seijanohai][Seireiseki][Sinkanohiseki][Subayasanotane][Gamegonrejendoimunokanmuri]
    		[Gamegonrejendoimuzeri][Syurizai][Tekkouseki][Tikaranotane][Tokinosuisyou][Tyounohane][Uruwasikinoko][Usaginosippo][Yakusou][Yawarakauru]
