...
public class DqmEntityDarkRamia extends DqmEntityMob
{
	...
	public DqmEntityDarkRamia(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/DarkRamia.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(3.0F, 3.0F);
		//*******************************Speed***************************************
		moveSpeed = 2.4F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 600;    }
	//*******************************Armor***************************************
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		//Randam 0-1
		this.dropItem(mod_Dqm.Paapuruoubu.shiftedIndex, 1);
	...
	case 2:dropItem(mod_Dqm.Honoonoyoroi.shiftedIndex, 1);                break;
