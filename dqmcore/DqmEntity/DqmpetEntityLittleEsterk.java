...
public class DqmpetEntityLittleEsterk extends DqmEntityTameable
{
	...
	public DqmpetEntityLittleEsterk(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		this.texture = "/dqm/LittleEsterk.png";
		//*******************************Size(yoko*tate)***************************************
	...
	{
		return this.isSitting() ? "/dqm/LittleEsterkpetzzz.png" : isTamed() ? "/dqm/LittleEsterkpet.png":(this.isAngry() ? "/dqm/LittleEsterk.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 200 : 200;    }
	//*******************************Armor***************************************
	@Override
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		...
		this.dropItem(mod_Dqm.Amatuyunoito.shiftedIndex, 1);
	...
	case 4:dropItem(mod_Dqm.Kazekirinoyumi.shiftedIndex, 1);                break;
	}}
	//*******************************PetItem/SENTOU_HP***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Sinkanohiseki.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityLittleEsterk var2 = new DqmpetEntityLittleEsterk(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityLittleEsterk))
		{
			return false;
		}
		else
		{
			DqmpetEntityLittleEsterk var2 = (DqmpetEntityLittleEsterk)par1EntityAnimal;
