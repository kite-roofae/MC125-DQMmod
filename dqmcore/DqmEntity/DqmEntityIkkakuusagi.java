...
public class DqmEntityIkkakuusagi extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityIkkakuusagi(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	{            this.entityToAttack = null;        }
		...
		if (this.onGround)                {
			...
			this.motionZ = var6 / var8 * 0.5D * 0.800000011920929D + this.motionZ * 1.00000000298023224D;
