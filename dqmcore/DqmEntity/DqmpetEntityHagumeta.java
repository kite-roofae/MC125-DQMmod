...
public class DqmpetEntityHagumeta extends EntityTameable
{
	...
	public DqmpetEntityHagumeta(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 12 : 12;    }
	//*******************************Armor***************************************
	@Override
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == Item.diamond.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityHagumeta var2 = new DqmpetEntityHagumeta(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityHagumeta))
		{
			return false;
		}
		else
