...
public class DqmEntitySuraimubesu extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntitySuraimubesu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Suraimubesu.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.4F, 0.4F);
		//*******************************Speed***************************************
		moveSpeed = 0.25F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 7;    }
	//*******************************Armor***************************************
	...
	/*
    		...
    		[Misriru][MysteryEgg][Oriharukon][Puratina][Rotonoha][Rotonotuka][Seijanohai][Seireiseki][Sinkanohiseki][Subayasanotane][Suraimubesuimunokanmuri]
    		[Suraimubesuimuzeri][Syurizai][Tekkouseki][Tikaranotane][Tokinosuisyou][Tyounohane][Uruwasikinoko][Usaginosippo][Yakusou][Yawarakauru]
