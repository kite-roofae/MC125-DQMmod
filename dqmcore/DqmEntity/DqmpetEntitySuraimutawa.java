...
public class DqmpetEntitySuraimutawa extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntitySuraimutawa(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Suraimutawa.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.3F;
	...
	{
		return this.isSitting() ? "/dqm/SuraimutawaPetzzz.png" : isTamed() ? "/dqm/SuraimutawaPet.png":(this.isAngry() ? "/dqm/Suraimutawa.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 28 : 28;    }
	//*******************************Armor***************************************
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		...
		//this.dropItem(mod_Dqm.??.shiftedIndex, 1);
		this.dropItem(mod_Dqm.Akaisango.shiftedIndex, 1);
	}
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Koorinokessyou.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntitySuraimutawa var2 = new DqmpetEntitySuraimutawa(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntitySuraimutawa))
		{
			return false;
		}
		else
		{
			DqmpetEntitySuraimutawa var2 = (DqmpetEntitySuraimutawa)par1EntityAnimal;
