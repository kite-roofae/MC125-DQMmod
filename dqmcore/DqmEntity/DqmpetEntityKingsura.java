...
public class DqmpetEntityKingsura extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntityKingsura(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Kingsura.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.5F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.32F;
	...
	{
		return this.isSitting() ? "/dqm/KingsuraPetzzz.png" : isTamed() ? "/dqm/KingsuraPet.png":(this.isAngry() ? "/dqm/Kingsura.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 30 : 30;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Hosinokakera.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityKingsura var2 = new DqmpetEntityKingsura(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityKingsura))
		{
			return false;
		}
		else
		{
			DqmpetEntityKingsura var2 = (DqmpetEntityKingsura)par1EntityAnimal;
