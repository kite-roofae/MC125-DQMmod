...
public class DqmEntityBehoimisuraimu extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityBehoimisuraimu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Behoimisuraimu.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 1.0F);
		//*******************************Speed***************************************
		moveSpeed = 0.35F;
	...
	/*
    		...
    		[Misriru][MysteryEgg][Oriharukon][Puratina][Rotonoha][Rotonotuka][Seijanohai][Seireiseki][Sinkanohiseki][Subayasanotane][Behoimisuraimuimunokanmuri]
    		[Behoimisuraimuimuzeri][Syurizai][Tekkouseki][Tikaranotane][Tokinosuisyou][Tyounohane][Uruwasikinoko][Usaginosippo][Yakusou][Yawarakauru]
	...
	//case 3:dropItem(mod_Dqm.Behoimisuraimuimuhead.shiftedIndex, 1);                break;
