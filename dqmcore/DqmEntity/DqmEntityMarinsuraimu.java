...
public class DqmEntityMarinsuraimu extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityMarinsuraimu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Marinsuraimu.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 0.8F);
		//*******************************Speed***************************************
		moveSpeed = 0.45F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 45;    }
	//*******************************Armor***************************************
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		...
		//this.dropItem(mod_Dqm.??.shiftedIndex, 1);
		this.dropItem(mod_Dqm.Siroikaigara.shiftedIndex, 1);
	}
	...
	/*
    		...
    		[Misriru][MysteryEgg][Oriharukon][Puratina][Rotonoha][Rotonotuka][Seijanohai][Seireiseki][Sinkanohiseki][Subayasanotane][Suraimutumuriimunokanmuri]
    		[Suraimutumuriimuzeri][Syurizai][Tekkouseki][Tikaranotane][Tokinosuisyou][Tyounohane][Uruwasikinoko][Usaginosippo][Yakusou][Yawarakauru]
	...
	//case 3:dropItem(mod_Dqm.Suraimutumuriimuhead.shiftedIndex, 1);                break;
