...
public class DqmpetEntitySura extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntitySura(World par1World)
	{
		super(par1World);
        //*******************************Texture***************************************
        texture = "/dqm/Sura.png";
        //*******************************Size(yoko*tate)***************************************
        setSize(0.4F, 0.4F);
        //*******************************Speed***************************************
        moveSpeed = 0.25F;
	...
	{
		return this.isSitting() ? "/dqm/SuraPetzzz.png" : isTamed() ? "/dqm/SuraPet.png":(this.isAngry() ? "/dqm/Sura.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 10 : 10;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Suraimuzeri.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntitySura var2 = new DqmpetEntitySura(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntitySura))
		{
			return false;
		}
		else
		{
			DqmpetEntitySura var2 = (DqmpetEntitySura)par1EntityAnimal;
