...
public class DqmEntityKisudragon extends DqmEntityMob
{

	private int field_40152_d;
	public DqmEntityKisudragon(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Kisudragon.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.0F);
		//*******************************Speed***************************************
		moveSpeed = 0.45F;
	...
	case 3:dropItem(mod_Dqm.Dragonrod.shiftedIndex, 1);                break;
