...
public class DqmEntityMetaruburazazu extends DqmEntityMob
{
	private int field_40152_d;
	public DqmEntityMetaruburazazu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Metaruburazazu.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.4F, 1.0F);
		//*******************************Speed***************************************
		//moveSpeed = 0.25F;
		...
		//ì¶Ç∞ÇÈ
		tasks.addTask(4, new EntityAIAvoidEntity(this, net.minecraft.src.EntityPlayer.class, 16F, 0.30F, 0.30F));
		//â£ÇÁÇÍÇΩÇÁçUåÇÇ∑ÇÈ
	...
	case 4:dropItem(mod_Dqm.Metarukingnokabuto.shiftedIndex, 1);                break;
