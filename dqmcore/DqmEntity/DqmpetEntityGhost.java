...
public class DqmpetEntityGhost extends DqmEntityTameable
{
	...
	public DqmpetEntityGhost(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Ghost.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.3F;
	...
	{
		return this.isSitting() ? "/dqm/GhostPetzzz.png" : isTamed() ? "/dqm/GhostPet.png": super.getTexture();
		//return this.isSitting() ? "/dqm/GhostPetzzz.png" : isTamed() ? "/dqm/GhostPet.png":(this.isAngry() ? "/dqm/Ghost.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 13 : 13;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Usaginosippo.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityGhost var2 = new DqmpetEntityGhost(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityGhost))
		{
			return false;
		}
		else
		{
			DqmpetEntityGhost var2 = (DqmpetEntityGhost)par1EntityAnimal;
