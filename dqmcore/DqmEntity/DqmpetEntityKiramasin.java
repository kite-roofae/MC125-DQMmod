...
public class DqmpetEntityKiramasin extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntityKiramasin(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	{
		return this.isSitting() ? "/dqm/KiramasinPetzzz.png" : isTamed() ? "/dqm/KiramasinPet.png":(this.isAngry() ? "/dqm/Kiramasin.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Metaru.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityKiramasin var2 = new DqmpetEntityKiramasin(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityKiramasin))
		{
			return false;
		}
		else
