...
public class DqmpetEntityMetoroghost extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntityMetoroghost(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Metoroghost.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 1.4F);
		//*******************************Speed***************************************
		moveSpeed = 0.3F;
	...
	{
		return this.isSitting() ? "/dqm/MetoroghostPetzzz.png" : isTamed() ? "/dqm/MetoroghostPet.png":(this.isAngry() ? "/dqm/Metoroghost.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Kinkai.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityMetoroghost var2 = new DqmpetEntityMetoroghost(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityMetoroghost))
		{
			return false;
		}
		else
		{
			DqmpetEntityMetoroghost var2 = (DqmpetEntityMetoroghost)par1EntityAnimal;
