...
public class DqmEntityBuraddihando extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityBuraddihando(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Buraddihando.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.2F);
		//*******************************Speed***************************************
		moveSpeed = 0.65F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 44;    }
	//*******************************Armor***************************************
