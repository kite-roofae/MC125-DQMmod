...
public class DqmpetEntityGoremu extends DqmEntityTameable
{
	//*******************************ATK***************************************
	protected int attackStrength = 12;
	/**
	...
	public DqmpetEntityGoremu(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Goremu.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(2.0F, 2.0F);
		//*******************************Speed***************************************
		moveSpeed = 0.3F;
	...
	{
		return this.isSitting() ? "/dqm/GoremuPetzzz.png" : isTamed() ? "/dqm/GoremuPet.png":(this.isAngry() ? "/dqm/Goremu.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 65 : 65;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Tekkouseki.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityGoremu var2 = new DqmpetEntityGoremu(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityGoremu))
		{
			return false;
		}
		else
		{
			DqmpetEntityGoremu var2 = (DqmpetEntityGoremu)par1EntityAnimal;
