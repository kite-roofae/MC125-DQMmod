...
public class DqmEntitySuraimutawa extends DqmEntityMob
{
	...
	public DqmEntitySuraimutawa(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	{            this.entityToAttack = null;        }
		...
		if (this.onGround)                {
			...
			this.motionX = var4 / var8 * 0.5D * 0.800000011920929D + this.motionX * 0.30000000298023224D;
			this.motionZ = var6 / var8 * 0.5D * 0.800000011920929D + this.motionZ * 0.30000000298023224D;
			this.motionY = 0.3000000059604645D;   }}
