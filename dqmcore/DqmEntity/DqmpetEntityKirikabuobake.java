...
public class DqmpetEntityKirikabuobake extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntityKirikabuobake(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Kirikabuobake.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.2F, 0.8F);
		//*******************************Speed***************************************
		moveSpeed = 0.3F;
	...
	{
		return this.isSitting() ? "/dqm/KirikabuobakePetzzz.png" : isTamed() ? "/dqm/KirikabuobakePet.png":(this.isAngry() ? "/dqm/Kirikabuobake.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 25 : 25;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Midorinokoke.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityKirikabuobake var2 = new DqmpetEntityKirikabuobake(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityKirikabuobake))
		{
			return false;
		}
		else
		{
			DqmpetEntityKirikabuobake var2 = (DqmpetEntityKirikabuobake)par1EntityAnimal;
