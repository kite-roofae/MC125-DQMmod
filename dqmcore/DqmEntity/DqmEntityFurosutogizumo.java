...
public class DqmEntityFurosutogizumo extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityFurosutogizumo(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Furosutogizumo.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.55F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 32;    }
	//*******************************Armor***************************************
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		//Randam 0-1
		this.dropItem(mod_Dqm.Nekozuna.shiftedIndex, 1);
