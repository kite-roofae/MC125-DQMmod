...
public class DqmpetEntityBakudaniwa extends DqmEntityTameable
{
	//*******************************ATK***************************************
	 ...
	 */
	int lastActiveTime;
	//protected int experienceValue = 1800;
	/**
	...
	public DqmpetEntityBakudaniwa(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	{
		return this.isSitting() ? "/dqm/BakudaniwaPetzzz.png" : isTamed() ? "/dqm/BakudaniwaPet.png": super.getTexture();//:(this.isAngry() ? "/dqm/BakudaniwaAng.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == Item.gunpowder.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityBakudaniwa var2 = new DqmpetEntityBakudaniwa(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityBakudaniwa))
		{
			return false;
		}
		else
		{
			DqmpetEntityBakudaniwa var2 = (DqmpetEntityBakudaniwa)par1EntityAnimal;
