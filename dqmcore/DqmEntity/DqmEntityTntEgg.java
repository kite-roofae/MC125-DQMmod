...
public class DqmEntityTntEgg extends EntityThrowable implements ITextureProvider
{
	public DqmEntityTntEgg(World par1World)
	{
		super(par1World);
	}

	public DqmEntityTntEgg(World par1World, EntityLiving par2EntityLiving)
	{
		super(par1World, par2EntityLiving);
	}

	public DqmEntityTntEgg(World par1World, double par2, double par4, double par6)
	{
