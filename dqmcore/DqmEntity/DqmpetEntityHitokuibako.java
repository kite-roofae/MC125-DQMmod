...
public class DqmpetEntityHitokuibako extends DqmEntityTameable
{
	//*******************************ATK***************************************
	protected int attackStrength = 9;
	/**
	...
	public DqmpetEntityHitokuibako(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Hitokuibako.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.2F, 1.2F);
		//*******************************Speed***************************************
		moveSpeed = 0.4F;
	...
	{
		return this.isSitting() ? "/dqm/HitokuibakoPetzzz.png" : isTamed() ? "/dqm/HitokuibakoPet.png": super.getTexture();
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Tokinosuisyou.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityHitokuibako var2 = new DqmpetEntityHitokuibako(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityHitokuibako))
		{
			return false;
		}
		else
		{
			DqmpetEntityHitokuibako var2 = (DqmpetEntityHitokuibako)par1EntityAnimal;
