...
public class DqmpetEntityKimera extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Kazekirinohane.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityKimera var2 = new DqmpetEntityKimera(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityKimera))
		{
			return false;
		}
		else
		{
			DqmpetEntityKimera var2 = (DqmpetEntityKimera)par1EntityAnimal;
