...
public class DqmEntityGamegonload extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityGamegonload(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Gamegonload.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(2.0F, 1.3F);
		//*******************************Speed***************************************
		moveSpeed = 0.25F;
	...
	//*******************************Armor***************************************
	public int getTotalArmorValue()    {        return 7;    }
	//*******************************Fall taisei***************************************
	...
	/*
    		...
    		[Misriru][MysteryEgg][Oriharukon][Puratina][Rotonoha][Rotonotuka][Seijanohai][Seireiseki][Sinkanohiseki][Subayasanotane][Gamegonloadimunokanmuri]
    		[Gamegonloadimuzeri][Syurizai][Tekkouseki][Tikaranotane][Tokinosuisyou][Tyounohane][Uruwasikinoko][Usaginosippo][Yakusou][Yawarakauru]
	...
	case 3:dropItem(mod_Dqm.Doragonmeiru.shiftedIndex, 1);                break;
