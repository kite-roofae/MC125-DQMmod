...
public class DqmEntitySamayoutamasii extends DqmEntityMob
{
	...
	public DqmEntitySamayoutamasii(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Samayoutamasii.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.7F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.5F;
	...
	if (this.isBurning())    {//Fire
		//this.dropItem(mod_Dqm.Samayoutamasiinotubasa.shiftedIndex, 1);
	...
	//case 2:dropItem(mod_Dqm.Samayoutamasiinotubasa.shiftedIndex, 1);                break;
