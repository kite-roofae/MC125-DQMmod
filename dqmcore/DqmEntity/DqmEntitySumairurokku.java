...
public class DqmEntitySumairurokku extends DqmEntityMob
{

	public DqmEntitySumairurokku(World par1World)
	{

		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Sumairurokku.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.0F);
		//*******************************Speed***************************************
		moveSpeed = 0.4F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 57;    }
	//*******************************Armor***************************************
	...
	if (this.isBurning())    {//Fire
		this.dropItem(mod_Dqm.Bekkou.shiftedIndex, 1);
