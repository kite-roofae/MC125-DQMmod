...
public class DqmEntitySuraimumadyura extends DqmEntityMob
{

	private int field_40152_d;
	public DqmEntitySuraimumadyura(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Suraimumadyura.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.5F, 1.5F);
		//*******************************Speed***************************************
		moveSpeed = 0.7F;
