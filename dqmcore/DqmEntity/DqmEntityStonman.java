...
public class DqmEntityStonman extends DqmEntityMob
{

	public DqmEntityStonman(World par1World)
	{

		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Stonman.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(2.0F, 2.6F);
		//*******************************Speed***************************************
		moveSpeed = 0.6F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 125;    }
	//*******************************Armor***************************************
	...
	case 3:dropItem(mod_Dqm.Majinnokanaduti.shiftedIndex, 1);                break;
	//case 2:dropItem(mod_Dqm.Sabitakutu.shiftedIndex, 1);                break;
	}}
	@Override
	protected void fall(float par1) {}
		...
		else
		{
			if (par2 > 2.0F && par2 < 6.0F && this.rand.nextInt(10) == 0)
			{
				if (this.onGround)
				{
					...
					this.motionX = var4 / var8 * 0.5D * 0.800000011920929D + this.motionX * 0.80000000298023224D;
					this.motionZ = var6 / var8 * 0.5D * 0.800000011920929D + this.motionZ * 0.80000000298023224D;
					this.motionY = 0.8000000059604645D;
