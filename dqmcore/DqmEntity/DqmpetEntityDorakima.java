...
public class DqmpetEntityDorakima extends DqmEntityTameable
{
	//*******************************ATK***************************************
	...
	public DqmpetEntityDorakima(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Dorakima.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(0.6F, 1.4F);
		//*******************************Speed***************************************
		moveSpeed = 0.34F;
	...
	{
		return this.isSitting() ? "/dqm/DorakimaPetzzz.png" : isTamed() ? "/dqm/DorakimaPet.png":(this.isAngry() ? "/dqm/Dorakima.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 21 : 21;    }
	//*******************************Armor***************************************
	...
	for (int var4 = 0; var4 < var3; ++var4)        {
		//Randam 0-1
		this.dropItem(mod_Dqm.Tyounohane.shiftedIndex, 1);
	...
	if (this.isBurning())    {//Fire
		...
		this.dropItem(mod_Dqm.Koumorinohane.shiftedIndex, 1);
		//this.dropItem(mod_Dqm.Hikarinoisi.shiftedIndex, 1);
		//this.dropItem(mod_Dqm.Tikaranotane.shiftedIndex, 1);
	}    	}
	/*
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Subayasanotane.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityDorakima var2 = new DqmpetEntityDorakima(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityDorakima))
		{
			return false;
		}
		else
		{
			DqmpetEntityDorakima var2 = (DqmpetEntityDorakima)par1EntityAnimal;
