...
public class DqmpetEntityGaikotukensi extends DqmEntityTameable
{
	protected int attackStrength = 8;
	/**
	...
	public DqmpetEntityGaikotukensi(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
	...
	{
		return this.isSitting() ? "/dqm/GaikotukensiPetzzz.png" : isTamed() ? "/dqm/GaikotukensiPet.png": super.getTexture();
		//return this.isSitting() ? "/dqm/GaikotukensiPetzzz.png" : isTamed() ? "/dqm/GaikotukensiPet.png":(this.isAngry() ? "/dqm/Gaikotukensi.png" : super.getTexture());
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 40 : 40;    }
	//*******************************Armor***************************************
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Yogoretahoutai.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityGaikotukensi var2 = new DqmpetEntityGaikotukensi(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityGaikotukensi))
		{
			return false;
		}
		else
		{
			DqmpetEntityGaikotukensi var2 = (DqmpetEntityGaikotukensi)par1EntityAnimal;
