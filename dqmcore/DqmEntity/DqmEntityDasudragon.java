...
public class DqmEntityDasudragon extends DqmEntityMob
{

	private int field_40152_d;
	public DqmEntityDasudragon(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Dasudragon.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.0F);
		//*******************************Speed***************************************
		moveSpeed = 0.5F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 120;    }
	//*******************************Armor***************************************
	...
	case 3:dropItem(mod_Dqm.Dragonwing.shiftedIndex, 1);                break;
