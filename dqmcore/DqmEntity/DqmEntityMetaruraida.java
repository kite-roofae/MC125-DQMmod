...
public class DqmEntityMetaruraida extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityMetaruraida(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Metaruraida.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.0F, 1.8F);
		//*******************************Speed***************************************
		moveSpeed = 0.8F;
	...
	case 3:dropItem(mod_Dqm.Doragonkira.shiftedIndex, 1);                break;
