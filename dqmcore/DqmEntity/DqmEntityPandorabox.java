...
public class DqmEntityPandorabox extends DqmEntityMob
{


	//EntityAnimal,EntityZombie,EntityMob,EntityWaterMob

	public DqmEntityPandorabox(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Pandorabox.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.2F, 1.2F);
		//*******************************Speed***************************************
		moveSpeed = 1.0F;
	...
	//*******************************HP***************************************
	@Override
	public int getMaxHealth()    {        return 90;    }
	//*******************************Armor***************************************
	...
	if (this.isBurning())    {//Fire
		this.dropItem(mod_Dqm.Sinkanohiseki.shiftedIndex, 1);
		//this.dropItem(mod_Dqm.??.shiftedIndex, 1);
		//this.dropItem(mod_Dqm.??.shiftedIndex, 1);
	}
	else        {             //100%
	...
	case 4:dropItem(mod_Dqm.Sinpinoyoroi.shiftedIndex, 1);                break;
	}}
	...
	{            this.entityToAttack = null;        }
		...
		if (this.onGround)                {
			...
			this.motionZ = var6 / var8 * 0.5D * 0.800000011920929D + this.motionZ * 0.60000000298023224D;
