...
public class DqmpetEntityKirapan extends DqmEntityTameable
{
	...
	public DqmpetEntityKirapan(World par1World)
	{
		super(par1World);
		//*******************************Texture***************************************
		texture = "/dqm/Kirapan.png";
		//*******************************Size(yoko*tate)***************************************
		setSize(1.2F, 1.2F);
		//*******************************Speed***************************************
		moveSpeed = 0.47F;
	...
	{
		return this.isSitting() ? "/dqm/KirapanPetzzz.png" : isTamed() ? "/dqm/KirapanPet.png": super.getTexture();
	}
	//*******************************HP(PetTameHP,MobHP***************************************
	@Override
	public int getMaxHealth()    {        return this.isTamed() ? 50 : 50;    }
	//*******************************Armor***************************************
	...
	case 3:dropItem(mod_Dqm.Papasunoturugi.shiftedIndex, 1);                break;
	...
	public boolean interact(EntityPlayer par1EntityPlayer)    {        ItemStack var2 = par1EntityPlayer.inventory.getCurrentItem();        if (!this.isTamed())        {
		if (var2 != null && var2.itemID == mod_Dqm.Yawarakauru.shiftedIndex && !this.isAngry())            {
	...
	{
		DqmpetEntityKirapan var2 = new DqmpetEntityKirapan(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
	{
		...
		else if (!(par1EntityAnimal instanceof DqmpetEntityKirapan))
		{
			return false;
		}
		else
		{
			DqmpetEntityKirapan var2 = (DqmpetEntityKirapan)par1EntityAnimal;
