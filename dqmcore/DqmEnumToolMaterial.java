...
public enum DqmEnumToolMaterial
{
	...
	HIKARI(1, 500, 12.0F, -2, 30),
	OO(3, 1100, 12.0F, 4, 5),
	AKUMA(3, 700, 12.0F, 2, 15),
	SEINARU(3, 600, 12.0F, 0, 25),
	YAIBA(3, 350, 12.0F, -1, 10),
	MAJUU(3, 800, 12.0F, 1, 15),
	ONI(3, 1300, 12.0F, 5, 10),
	ATORASU(3, 1200, 12.0F, 7, 10),
	GUREITO(3, 1300, 12.0F, 8, 10),
	IKAZUTI(3, 300, 12.0F, -2, 25),
