...
public final class mo_DqmSpawner
{
	...
	public mo_DqmSpawner()
    {
    	...
    	try
        {
        	...
        	DqmMobClassList = new ArrayList<Class>();
        	DqmPetMobClassList = new ArrayList<Class>();
        	DqmWaterMobClassList = new ArrayList<Class>();
    ...
    public void addCustomSpawn(Class class1, int i, int j, int k, EnumCreatureType enumcreaturetype, BiomeGenBase abiomegenbase[])
    {
    	...
    	{
        	DqmMobClassList.add(class1);
    	}
    	if(enumcreaturetype == EnumCreatureType.creature)
    	{
        	DqmPetMobClassList.add(class1);
    	}
    	if(enumcreaturetype == EnumCreatureType.waterCreature)
    	{
        	DqmWaterMobClassList.add(class1);
    	}
        if(class1 == null)
        {
   ...
   private List[] getCustomSpawnableList(EnumCreatureType enumcreaturetype)
    ...
    {
    	if (entityliving instanceof DqmEntityTameable && ((DqmEntityTameable)entityliving).isTamed())
    	{
    		return 0;
    	}
